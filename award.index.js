...
client.on("guildCreate", (guild) => updateActions({ channel: '952228302544838676', title: 'New guild', color: 'GREEN', guild: guild }));
client.on("guildDelete", (guild) => updateActions({ channel: '952228302544838676', title: 'Guild deleted', color: 'RED', guild: guild }));
